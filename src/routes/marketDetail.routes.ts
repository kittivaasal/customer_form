...
import { createMarketDetail, deleteMarketDetail, getAllMarketDetail, getByIdMarketDetail, getBothMarketerMarketerHead, updateMarketDetail } from "../controllers/marketDetail.controller";
